...
class BlockTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        def mocked_query(module, storage_function, block_hash):
            ...
            raise ValueError(
                f"Unsupported mocked query {module}.{storage_function} @ {block_hash}"
            )

        def mocked_make_rpc_request(
            payloads: list[dict],
            ...
            for payload in payloads:
                ...
                if method in [
                    ...
                    # Raises decoding errors
                        ...
                        params[0]
                        == "0x40b98c29466fa76eeee21008b50d5cb5d7220712ead554eb97a5fd6ba4bc31b5"
                    ):
                        return {
                            "jsonrpc": "2.0",
                            "result": {
        ...
        cls.substrate._make_rpc_request = MagicMock(side_effect=mocked_make_rpc_request)
        cls.substrate.query = MagicMock(side_effect=mocked_query)

        cls.babe_substrate = SubstrateInterface(url=settings.BABE_NODE_URL)
    ...
    def test_check_requirements(self):
        ...
        self.assertRaises(
            ValueError,
            self.substrate.get_block_header,
            block_hash="0xec828914eca09331dad704404479e2899a971a9b5948345dc40abca4ac818f93",
            block_number=223,
        )
        self.assertRaises(
